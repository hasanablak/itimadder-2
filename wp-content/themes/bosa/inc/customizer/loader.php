...
function bosa_default_styles(){
	...
	$css .= '
		body[class*=woocommerce] ul.products li.product .button-cart_button_two a.add_to_cart_button {
		...
		body[class*=woocommerce] ul.products li.product .button-cart_button_two a.add_to_cart_button:hover,
		body[class*=woocommerce] ul.products li.product .button-cart_button_two a.add_to_cart_button:focus,
	...
	if( $sale_tag_layout == 'sale_tag_layout_two' ){
		$css .= '
